...
import net.digihippo.aoc.TwentyTwo.Bound;
import net.digihippo.aoc.TwentyTwo.Bounds;
import net.digihippo.aoc.TwentyTwo.Point;
...
import static net.digihippo.aoc.TwentyTwo.newBounds;
import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertTrue;

class TwentyTwoTest {

    private final String exampleTwoInput = """
    ...
    void examplePartOneA() throws IOException {
        assertEquals(39, TwentyTwo.onCubes(Inputs.asInputStream("""
    ...
    void examplePartOne() throws IOException {
        assertEquals(590784, TwentyTwo.onCubes(Inputs.asInputStream("""
    ...
    void partOne() throws IOException {
        System.out.println(TwentyTwo.onCubes(Inputs.puzzleInput("twentytwo.txt")));
    }

    @Test
    void partTwoExample() throws IOException {
        assertEquals(474140, TwentyTwo.onCubes(Inputs.asInputStream(exampleTwoInput)));
    }

    @Test
    void partTwoInFull() throws IOException {
        assertEquals(2758514936282235L, TwentyTwo.onCubesPartTwo(Inputs.asInputStream(exampleTwoInput)));
    }
    ...
    void overlap() {
        ...
        final Bounds second = newBounds(
                true,
                new Bound(new Point(5, 5, 5)),
                new Bound(new Point(10, 10, 10)));

        assertEquals(
                List.of(first, second),
                first.overlappedWith(second)
        );
    }
...
//        );
    ...
    void turnEverythingOff() {
        ...
        assertEquals(0, first.onCount());
    }

    @Test
    public void turnOffOverlapWithAnotherOnThing()
    {
        final Bounds first = newBounds(
                true,
                new Bound(new Point(1, 1, 1)),
        ...
        assertEquals(19, first.onCount());
    }

    @Test
    public void turnOffOverlapWithTwoOnThings()
    {
        final Bounds first = newBounds(
                true,
                new Bound(new Point(1, 1, 1)),
    ...
    void doAnyOffSectionsOverlap() throws IOException {
        ...
        for (Bounds bound : bounds) {
            if (bound.outOfRange() && !bound.on())
            {
                offOor.add(bound);
            }
        }

        for (Bounds b1 : offOor) {
            for (Bounds b2 : offOor) {
