...
class NineteenTest {
    ...
    private final String bigExample = """
            --- scanner 0 ---
            404,-588,-901
            528,-643,409
            -838,591,734
    ...
    void findBeaconsExampleTwo() throws IOException {
        assertEquals(79, Nineteen.beacons(12, Inputs.asInputStream(bigExample)));
    }
...
3 = {Nineteen$Observation@1749} "Observation[scannerName=--- scanner 4 ---, one=Point[x=-660, y=-479, z=-426], two=Point[x=-627, y=-443, z=-432]]"
    ...
    void manhattanDistance() {
        int distance = new Point(1105, -1205, 1229).manhattanDistance(new Point(-92, -2380, -20));
        assertEquals(3621, distance);
    }

    @Test
    void examplePartTwo() throws IOException {
        assertEquals(3621, Nineteen.largestScannerDistance(12, Inputs.asInputStream(bigExample)));
    }

    @Test
    void partTwo() throws IOException {
        System.out.println(Nineteen.largestScannerDistance(12, Inputs.puzzleInput("nineteen.txt")));
    }
}